          ...
          <Card className="max-w-2xl mx-auto border shadow-sm">
            ...
            <CardContent className="space-y-6">
              <p className="text-center text-muted-foreground">
                Career Services will reach out with interested employers soon.
                <br />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                ...
                <Card className="border relative shadow-sm hover:shadow transition-shadow overflow-hidden">
                  <div className="bg-slate-200/90 absolute inset-0 items-center flex justify-center">
                    Coming soon
                  </div>
                  <CardContent className="p-4 flex flex-col items-center text-center">
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-3 mt-4">
              ...
              <div className="bg-secondary border-l-4 border-primary p-4 mt-6">
                <p className="text-foreground text-sm">
                  ...
                  <br />
                  <a
                    href="mailto:careers@tidewater.edu"
