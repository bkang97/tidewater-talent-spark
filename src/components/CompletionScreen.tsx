  ...
  return (
    <div className="min-h-screen bg-charcoal-900 flex">
      ...
      <div className="flex-1 flex flex-col">
        <header className="w-full bg-charcoal-800 p-4 flex items-center">
          <MobileSidebar />
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                <Card className="bg-charcoal-700 border-0 shadow hover:shadow-md transition-shadow">
                  <CardContent className="p-4 flex flex-col items-center text-center">
                    <div className="w-10 h-10 rounded-full bg-tidewater-500/20 flex items-center justify-center mb-3 mt-4">
                      <User className="w-5 h-5 text-tidewater-500" />
                    </div>
                ...
                <Card className="bg-charcoal-700 border-0 shadow hover:shadow-md transition-shadow">
                  <CardContent className="p-4 flex flex-col items-center text-center">
                    <div className="w-10 h-10 rounded-full bg-tidewater-500/20 flex items-center justify-center mb-3 mt-4">
                      <Briefcase className="w-5 h-5 text-tidewater-500" />
                    </div>
                ...
                <Card className="bg-charcoal-700 border-0 shadow hover:shadow-md transition-shadow">
                  <CardContent className="p-4 flex flex-col items-center text-center">
                    <div className="w-10 h-10 rounded-full bg-tidewater-500/20 flex items-center justify-center mb-3 mt-4">
                      <Settings className="w-5 h-5 text-tidewater-500" />
                    </div>
